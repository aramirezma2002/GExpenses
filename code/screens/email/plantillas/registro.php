    ...
    <div class="principal" weight="600" height="600">
        ...
        <div class="mensaje">
            ...
            <div class="actividad">
                ...
                <a href="/code/screens/email/emailScripts/tokenreader.php?token=<?php echo $token ?>&acceptat=true">Registra't per acceptar la invitació!</a>
                <a href="/code/screens/email/emailScripts/tokenreader.php?token=<?php echo $token ?>&acceptat=flase">Rebiutja l'invitació</a>
            </div>
        </div>
    </div>
</body>
