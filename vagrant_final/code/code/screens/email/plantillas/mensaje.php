...
<body>
    ...
    <div class="principal">
        ...
        <div class="mensaje">
            <h1 a>Hola, <?php echo $invitat[0] ?></h1>
        </div>
        <div class="mensaje">
            <h3><?php echo $invitant[0] ?> (<?php echo $invitant[1] ?>) t'ha invitat a la seguent activitat:</h3>
            <div class="actividad">
                <h2><?php echo $activitat[0] ?></h2>
                <h2><?php echo $activitat[2] ?> <?php echo $activitat[1] ?></h2>
                <a href="http://localhost:1232/code/screens/email/emailScripts/tokenreader.php?token=<?php echo $token ?>&acceptat=true">Accepta aqui!</a>
                <a href="http://localhost:1232/code/screens/email/emailScripts/tokenreader.php?token=<?php echo $token ?>&acceptat=flase">Rebutja l'invitació</a>
            </div>
        </div>
    </div>
</body>
